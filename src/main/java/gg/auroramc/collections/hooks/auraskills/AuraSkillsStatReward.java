...
public class AuraSkillsStatReward extends NumberReward {
    @Getter
    private static final String AURA_SKILLS_STAT = "AURORA_COLLECTIONS_";
    @Getter
    private Stat stat;
    ...
    public void init(ConfigurationSection args) {
        ...
        if (stat == null) {
            AuroraCollections.logger().warning("Invalid stat in AuraSkillsStatReward: " + args.getString("stat"));
        }
    }
